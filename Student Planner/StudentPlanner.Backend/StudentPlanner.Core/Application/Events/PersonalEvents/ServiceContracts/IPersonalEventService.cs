...
public interface IPersonalEventService
{
    ...
    Task<Guid> CreatePersonalEventAsync(Guid userId, Guid eventId, CreatePersonalEventRequest request);
    Task UpdatePersonalEventAsync(Guid userId, UpdatePersonalEventRequest request);
