...
namespace StudentPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20260428110638_PolymorphicEvents")]
    partial class PolymorphicEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentPlanner.Core.Domain.AcademicEvent", b =>
                {
                    ...
                    b.HasDiscriminator<string>("EventType").HasValue("AcademicEvent");
            ...
            modelBuilder.Entity("StudentPlanner.Core.Domain.Entities.Faculty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudentPlanner.Core.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudentPlanner.Core.Domain.FacultyEvent", b =>
                {
                    b.HasBaseType("StudentPlanner.Core.Domain.AcademicEvent");

                    b.HasDiscriminator().HasValue("Faculty");
                });

            modelBuilder.Entity("StudentPlanner.Core.Domain.UniversityEvent", b =>
                {
                    b.HasBaseType("StudentPlanner.Core.Domain.AcademicEvent");
            ...
            modelBuilder.Entity("StudentPlanner.Core.Domain.AcademicEvent", b =>
                {
                    ...
                    b.HasOne("StudentPlanner.Core.Domain.Entities.Faculty", "Faculty")
                        .WithMany()
